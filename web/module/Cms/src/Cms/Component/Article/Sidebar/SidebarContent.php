...
abstract class SidebarContent extends BaseComponent implements ComponentInterface{
	
	protected $categoryId   = null;//文章分类的id
	
	protected $categoryName = null;//文章分类的名称
	
	protected $childrenElementCount = 5;//侧边栏文章分类的个数或者文章标题的个数
	 ...
	 * $param $count
	 */
	public function setChildrenElementCount($count){
		$this->childrenElementCount = $count;
		return $this;
	}
