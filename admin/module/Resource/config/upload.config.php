...
if(isset($CustomerConfigArray['website']['video_upload_max_size'])){
	$video_upload_max_size = $CustomerConfigArray['website']['video_upload_max_size'].'MB';
}else{
	$video_upload_max_size = '1500MB';
}

if(isset($CustomerConfigArray['website']['courseware_upload_max_size'])){
	$courseware_upload_max_size = $CustomerConfigArray['website']['courseware_upload_max_size'].'MB';
}else{
	$courseware_upload_max_size = '15MB';
}
